...
/*   Updated: 2022/10/12 12:17:51 by jmaia            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//static t_point2d	to_checkerboard_pos_from_cylinder(t_point point);
//static t_point2d	to_checkerboard_pos_from_ellipsoid(t_point point);
...
//		board_pos = to_checkerboard_pos_from_cylinder(intersection);
//	else if (obj->type == PLANE)
//		board_pos = to_checkerboard_pos_from_plane(intersection);
//	else if (obj->type == ELLIPSOID)
//		board_pos = to_checkerboard_pos_from_ellipsoid(intersection);
	return (board_pos);
}
